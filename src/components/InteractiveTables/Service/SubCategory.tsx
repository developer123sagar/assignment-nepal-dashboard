...
export const columns: ColumnDef<Payment>[] = [
  ...
  createBoxStatusColumn('featured', 'Featured'),
...
const SubCategoryTable = ({ userId }: { userId?: string }) => {
  console.log(userId);

  return (
    <>
      <div className="flex justify-between items-center mb-4 bg-gray-3 dark:bg-graydark p-5 rounded-2xl">
        <span className="text-2xl text-black">Sub Category List</span>

        <Link to="/add-sub-category">
          <Button variant="default" size="lg">Add Sub Category</Button>
        </Link>
      </div>
